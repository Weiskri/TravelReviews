...
namespace TravelReviews.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Author,Title,Content,PublishedDate,Recommended,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Author,Title,Content,PublishedDate,Recommended,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
